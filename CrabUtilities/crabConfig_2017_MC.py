...
workname ='setup_LL_UltraLegacy_V1'
...
PERIOD="D"
DATAJEC='Summer19UL17_Run'+PERIOD+'_V5_DATA' ## this is not used at this moment
...
config.JobType.inputFiles = ['../MetaData/data/DNN_models/model-51.pb',  ## this is for b-jet regression
                             ...
                             '../TreeMaker/data/RegroupedV2_Summer19UL17_V5_MC_UncertaintySources_AK4PFchs.txt'
                             ]
